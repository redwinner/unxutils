...
{
  out.begin_comment("Page:").comment_arg(iitoa(n));
  out.comment_arg(iitoa(++pages_output)).end_comment();
  output_style.f = 0;
...
ps_printer::~ps_printer()
{
  ...
  out.begin_comment("Pages:").comment_arg(iitoa(pages_output)).end_comment();
